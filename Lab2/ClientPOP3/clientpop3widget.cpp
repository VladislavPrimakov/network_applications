...
void ClientPOP3Widget::ShowAuthForm(){
    ...
    adressLine = new QLineEdit("pop.gmail.com");
...
void ClientPOP3Widget::LogIn(){
    ...
    emailLine->setText("Primakov2002@gmail.com");
    passLine->setText("ejsz xjjf tehj fnfe");
}
...
QString ClientPOP3Widget::FindTag(const QString& s, QString tag){
    ...
    while (1){
        ...
        ra.chop(2);
        ra += Imap::decodeRFC2047String(r.toLatin1());
